  ...
  47: [
    {
      ...
      body: 'In 2023, researchers at NewsGuard identified over 400 websites publishing entirely AI-generated news articles — with no human editors, no bylines, and no fact-checking. In 2024, a study found that 17% of all content on major social media platforms showed signs of AI generation. Amazon\'s Kindle store was flooded with AI-generated books at such scale that legitimate authors reported their names being attached to books they never wrote. Researchers estimate that by 2026, the majority of content on the public internet may be AI-generated. We are not approaching an era of AI-generated content. We are already inside it.<div class="hook-stats-row"><div class="hook-stat-mini"><span class="sv">400+</span><span class="sl">AI-only news websites identified by NewsGuard in 2023</span></div><div class="hook-stat-mini"><span class="sv">17%</span><span class="sl">of social media content shows signs of AI generation (2024)</span></div><div class="hook-stat-mini"><span class="sv">&gt;50%</span><span class="sl">of internet content predicted to be AI-generated by 2026</span></div></div>The question is no longer "could this be AI-generated?" The question is how you detect it — and what to do when you can\'t.'
    },
    {
      type: 'concept',
    ...
    },
    {
      ...
      questions: [
        { num: 1, text: 'If over half of internet content is AI-generated by 2026, what happens to collective knowledge? Wikipedia, for example, has explicitly banned AI-generated content — but cannot verify compliance. Is an accurate internet even maintainable at this scale?' },
