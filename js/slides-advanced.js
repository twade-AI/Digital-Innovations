...
var SLIDES_ADVANCED = {
  ...
  57: [
    ...
    },
    {
      ...
      instructions: 'Pick three tasks from the list below. Run each task on a chat model (Claude 4.6 Sonnet, GPT-5.4, or Gemini 3.5 Pro — whichever you have access to) and then on its reasoning counterpart (Claude extended thinking, o3, or Gemini 3.5 Pro Deep Think). For each task record: which produced the better answer, how long each took, and whether the reasoning model\'s chain (if visible) revealed anything useful or concerning.',
      steps: [
