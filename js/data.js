...
const GLOSSARY = [
  ...
  { term: 'LLM (Large Language Model)', definition: 'An AI model trained on vast amounts of text data that can generate, summarise, translate, and reason about language. Examples include GPT-5.4 (OpenAI), Claude 4.6 (Anthropic), Gemini 3.5 Pro (Google), and Llama (Meta).', lessons: [2, 9, 15] },
