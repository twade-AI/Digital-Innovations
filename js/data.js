...
const UNITS = [
  ...
  },
  {
    ...
    lessons: [
      ...
      { id:59, difficulty:"intermediate", title:"After the Apocalypse: Regulating AI Companions", desc:"The Replika story was not a one-off. Work through four real cases of AI-companion harm — including the death of a 14-year-old — find the structural pattern that connects them, then design a regulation that would actually work. The constraints are real, and so are the trade-offs.", tags:["activity","ethics","policy","critical-thinking"], objectives:["Extract structural patterns common to multiple AI-companion harm cases","Synthesise a generalised principle from specific examples","Draft a workable, enforceable regulation under tight constraints","Identify the strongest counter-argument to a position you hold"], resources:["r20","r12"], prereqs:[58] },
    ]
  },
  {
    id: 3,
