...
const UNITS = [
  ...
  },
  {
    ...
    lessons: [
      ...
      { id:53, difficulty:"advanced", title:"RAG & AI Agents",                       desc:"Understand how NotebookLM uses Retrieval-Augmented Generation (RAG) to ground answers, test citation reliability, and analyse autonomous agents.", tags:["theory","practical"], objectives:["Explain the RAG pipeline from document indexing to grounded generation","Analyse how NotebookLM generates source-based citations and where RAG fails","Describe the ReAct agent architecture and common tool types","Evaluate the oversight challenges that arise when autonomous agents act in the world"], resources:["r1","r3"], prereqs:[9,52] },
  ...
  },
  {
    ...
    lessons: [
      ...
      { id:48, difficulty:"intermediate", title:"Thinking With vs. Thinking For",   desc:"Understand the school's Three-Tier AI Policy, evaluate the cognitive cost of AI summaries, and design your protocol for active learning.", tags:["reflection","discussion","critical-thinking"], objectives:["Define the Green, Amber, and Red tiers of school AI usage","Analyse the risks of cognitive offloading using the NotebookLM audio overview scenario","Explain why struggle builds memory and competence","Design personal protocols for maintaining cognitive independence"], resources:["r4"] },
      ...
      { id:44, difficulty:"advanced", title:"The AI Manifesto",                    desc:"Write your personal AI manifesto — a code of conduct for using Gemini and NotebookLM responsibly prior to the school rollout.", tags:["writing","reflection","critical-thinking"], objectives:["Synthesise course learning into a coherent personal code of conduct","Articulate specific commitments on data privacy and citation validation","Address the tensions and trade-offs of using Gemini/NotebookLM in school","Create a forward-looking manifesto you can genuinely defend"], resources:["r11","r4"] },
    ]
  }
];
...
const GLOSSARY = [
  ...
  { term: 'Retrieval-Augmented Generation (RAG)', definition: 'A technique where the AI first retrieves relevant passages from a trusted document store, then writes its answer grounded in what it found — reducing hallucinations and enabling real citations. The architecture behind NotebookLM.', lessons: [53] },
