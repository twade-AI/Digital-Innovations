...
const GLOSSARY = [
  ...
  { term: 'LLM (Large Language Model)', definition: 'An AI model trained on vast amounts of text data that can generate, summarise, translate, and reason about language. Examples include GPT-5.4 (OpenAI), Claude Opus 4.8 (Anthropic), Gemini 3.5 Pro (Google), and Llama (Meta).', lessons: [2, 9, 15] },
  ...
  { term: 'Token', definition: 'The basic unit of text that LLMs process — roughly a word or word fragment. Models like GPT-5.4 and Claude Opus 4.8 process text as sequences of tokens, not as whole sentences or meanings.', lessons: [2, 9] },
...
const AI_TIMELINE = [
  ...
  {
    year: 2026,
    title: "Gemini 3.5 Pro — Google's Integrated Frontier Model",
    summary: "Google releases Gemini 3.5 Pro, deeply integrated into Google Workspace, Android, and Google Search — making frontier AI accessible to anyone with a Google account.",
    detail: "Gemini 3.5 Pro brought frontier-level capability to users through Google's existing product ecosystem: Gmail, Docs, Drive, and Search. For education, its integration with Google Workspace for Education meant many schools — including those on Google accounts — could access state-of-the-art AI without a separate subscription. Haileybury pupils have access to Gemini through their school Google accounts. The release intensified competition with OpenAI and Anthropic and raised questions about data privacy when pupils use school-integrated AI tools.",
    people: ["Demis Hassabis", "Sundar Pichai"],
    category: "tools",
    icon: "⭐"
  },
